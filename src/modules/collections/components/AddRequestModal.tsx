...
const AddRequestToCollectionModal = ({
  isModalOpen,
  setIsModalOpen,
  requestData = {
    name: "Untitled",
              ...
              filteredCollections.map((collection) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    {selectedCollectionId === collection.id ? (
                      <div className="w-4 h-4 rounded-full bg-indigo-800 flex items-center justify-center">
...
export default AddRequestToCollectionModal;
